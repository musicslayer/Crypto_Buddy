...
public class DeleteFoundTokensSettingsView extends CrashLinearLayout {
    ...
    public DeleteFoundTokensSettingsView(Context context) {
        ...
        confirmDeleteTokensDialogFragment_w = new WeakReference<>(BaseDialogFragment.newInstance(ConfirmDeleteTokensDialog.class, "Found"));
        confirmDeleteTokensDialogFragment_w.get().setOnDismissListener(new CrashDialogInterface.CrashOnDismissListener(context) {
            ...
            public void onDismissImpl(DialogInterface dialog) {
                if(((ConfirmDeleteTokensDialog)dialog).isComplete) {
                    ...
                    ToastUtil.showToast(context,"reset_found_tokens");
                }
            }
        });
        confirmDeleteTokensDialogFragment_w.get().restoreListeners(context, "reset_delete_found_tokens_settings_view");
        ...
        B_DELETE.setOnClickListener(new CrashView.CrashOnClickListener(context) {
            public void onClickImpl(View v) {
                confirmDeleteTokensDialogFragment_w.get().show(context, "reset_delete_found_tokens_settings_view");
            }
        });
