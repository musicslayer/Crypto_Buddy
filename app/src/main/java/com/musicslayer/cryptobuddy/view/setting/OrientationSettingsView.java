...
public class OrientationSettingsView extends CrashLinearLayout {
    public OrientationSettingsView(Context context) {
        super(context);
    }

    public OrientationSettingsView(Context context, String settingName, String settingDisplayName, String[] settingOptions, String[] settingDescriptions) {
        super(context);
