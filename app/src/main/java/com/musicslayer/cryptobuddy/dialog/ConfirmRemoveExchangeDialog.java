...
public class ConfirmRemoveExchangeDialog extends BaseDialog {
    public ConfirmRemoveExchangeDialog(Activity activity) {
        super(activity);
    }

    public int getBaseViewID() {
        return R.id.confirm_remove_exchange_dialog;
    }
    ...
    public void createLayout(Bundle savedInstanceState) {
        setContentView(R.layout.dialog_confirm_remove_exchange);

        ConfirmationView C = findViewById(R.id.confirm_remove_exchange_dialog_confirmationView);
        ...
        Button B_CANCEL = findViewById(R.id.confirm_remove_exchange_dialog_cancelButton);
