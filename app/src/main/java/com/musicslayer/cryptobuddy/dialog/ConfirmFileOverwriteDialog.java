...
public class ConfirmFileOverwriteDialog extends BaseDialog {
    ...
    public int getBaseViewID() {
        return R.id.confirm_file_overwrite_dialog;
    }
    ...
    public void createLayout(Bundle savedInstanceState) {
        setContentView(R.layout.dialog_confirm_file_overwrite);

        ConfirmationView C = findViewById(R.id.confirm_file_overwrite_dialog_confirmationView);
        ...
        Button B_CANCEL = findViewById(R.id.confirm_file_overwrite_dialog_cancelButton);
