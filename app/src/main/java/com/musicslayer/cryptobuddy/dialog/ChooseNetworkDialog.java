...
public class ChooseNetworkDialog extends BaseDialog {
    ...
    public ChooseNetworkDialog(Activity activity, ArrayList<CryptoAddress> cryptoAddressArrayList) {
        super(activity);
        this.cryptoAddressArrayList = cryptoAddressArrayList;
    }

    public int getBaseViewID() {
        return R.id.choose_network_dialog;
    }
    ...
    public void createLayout(Bundle savedInstanceState) {
        ...
        BorderedSpinnerView bsv = findViewById(R.id.choose_network_dialog_spinner);
        bsv.setOptions(options);

        Button B = findViewById(R.id.choose_network_dialog_button);
