...
public class ConfirmRemoveAddressDialog extends BaseDialog {
    public ConfirmRemoveAddressDialog(Activity activity) {
        super(activity);
    }

    public int getBaseViewID() {
        return R.id.confirm_remove_address_dialog;
    }
    ...
    public void createLayout(Bundle savedInstanceState) {
        setContentView(R.layout.dialog_confirm_remove_address);

        ConfirmationView C = findViewById(R.id.confirm_remove_address_dialog_confirmationView);
        ...
        Button B_CANCEL = findViewById(R.id.confirm_remove_address_dialog_cancelButton);
