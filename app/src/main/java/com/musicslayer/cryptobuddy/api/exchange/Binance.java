...
public class Binance extends ExchangeAPI {
    ...
    public void authorize(Activity activity, ExchangeAPI.AuthorizationListener L) {
        ...
        progressDialogFragment.setOnDismissListener(new CrashDialogInterface.CrashOnDismissListener(activity) {
            ...
            public void onDismissImpl(DialogInterface dialog) {
                ...
                if(token == null) {
                    ...
                    L.onAuthorization("Binance", token);
                }
            }
        });
        ...
        BaseDialogFragment exchangeWebViewDialogFragment = BaseDialogFragment.newInstance(ExchangeWebViewDialog.class, "Authorize Binance", authURLBase, authURL);
